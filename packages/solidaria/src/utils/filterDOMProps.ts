...
// Ported to SolidJS for Proyecto Viviana; based on packages/react-aria/src/utils/filterDOMProps.ts

/**
 * filterDOMProps for Solidaria
 *
 * Filters out all props that aren't valid DOM props.
 * Ported from packages/react-aria/src/utils/filterDOMProps.ts.
 */
