...
// Ported to SolidJS for Proyecto Viviana; based on packages/react-aria/src/utils/chain.ts
// Ported to SolidJS for Proyecto Viviana; based on packages/react-aria/src/utils/isVirtualEvent.ts
