...
// Ported to SolidJS for Proyecto Viviana; based on packages/react-aria/src/color/useColorSlider.ts
// Ported to SolidJS for Proyecto Viviana; based on packages/react-aria/src/color/useColorSwatch.ts
// Ported to SolidJS for Proyecto Viviana; based on packages/react-aria/src/color/useColorWheel.ts
 ...
 * - packages/react-aria/src/color/useColorField.ts
 * - packages/react-aria/src/color/useColorSlider.ts
 * - packages/react-aria/src/color/useColorSwatch.ts
