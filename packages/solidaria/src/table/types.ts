...
// Ported to SolidJS for Proyecto Viviana; based on packages/react-aria/src/table/useTableColumnHeader.ts
// Ported to SolidJS for Proyecto Viviana; based on packages/react-aria/src/table/useTableHeaderRow.ts
// Ported to SolidJS for Proyecto Viviana; based on packages/react-aria/src/table/useTableRow.ts
