...
import { describe, it, expect, vi, afterEach } from "vite-plus/test"; import { render, screen, cleanup, fireEvent, waitFor } from "@solidjs/testing-library"; import { createFocusWithin, type FocusWithinProps } from "../src/interactions/createFocusWithin"; import { createSignal, type Component, type JSX } from "solid-js";
