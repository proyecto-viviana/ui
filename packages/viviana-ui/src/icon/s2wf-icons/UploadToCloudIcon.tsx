 ...
 * Do not edit by hand.
 */
// Generator input: @react-spectrum/s2@1.7.0/icons/UploadToCloud.mjs
// Generator input: @react-spectrum/s2@1.7.0/icons/UploadToCloud.cjs

import type { JSX } from "@solidjs/web";
import { createIcon } from "../spectrum-icon";
import { splitProps } from "@proyecto-viviana/solidaria/utils";

function UploadToCloudIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type UploadToCloudIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const UploadToCloudIcon = createIcon(UploadToCloudIconSvg);
