 ...
 * Do not edit by hand.
 */
// Generator input: @react-spectrum/s2@1.6.0/icons/TagStrikeThrough.mjs
// Generator input: @react-spectrum/s2@1.6.0/icons/TagStrikeThrough.cjs

import { type JSX } from "solid-js";
import { createIcon } from "../spectrum-icon";

function TagStrikeThroughIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type TagStrikeThroughIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const TagStrikeThroughIcon = createIcon(TagStrikeThroughIconSvg);
export default TagStrikeThroughIcon;
