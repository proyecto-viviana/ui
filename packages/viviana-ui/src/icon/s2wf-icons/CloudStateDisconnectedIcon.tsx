 ...
 * Do not edit by hand.
 */
// Generator input: @react-spectrum/s2@1.6.0/icons/CloudStateDisconnected.mjs
// Generator input: @react-spectrum/s2@1.6.0/icons/CloudStateDisconnected.cjs

import { type JSX } from "solid-js";
import { createIcon } from "../spectrum-icon";

function CloudStateDisconnectedIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type CloudStateDisconnectedIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const CloudStateDisconnectedIcon = createIcon(CloudStateDisconnectedIconSvg);
export default CloudStateDisconnectedIcon;
