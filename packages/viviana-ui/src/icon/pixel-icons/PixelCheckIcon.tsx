...
function PixelCheckIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type PixelCheckIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const PixelCheckIcon = createIcon(PixelCheckIconSvg);
