...
function PixelZapIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type PixelZapIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const PixelZapIcon = createIcon(PixelZapIconSvg);
export default PixelZapIcon;
