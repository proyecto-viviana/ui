...
>(
  {
    ...focusRing(),
    ...staticColorStyle(),
    /* 6px. Only the focus ring's corner ever shows it, but `sm` (4px) is not a
     * corner this register draws — see the radius map in style/spectrum-theme.ts,
     * whose Glasselated block records the drawn ladder as 5 / 6 / 8 / 10 / 12 / 14.
     * `row` is the same corner tabs/index.tsx already spells, and a breadcrumb item
     * IS a link, so the two take one corner rather than splitting 6 and 5 over a
