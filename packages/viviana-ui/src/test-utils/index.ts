...
// Ported to SolidJS for Proyecto Viviana; based on packages/@react-aria/test-utils/src/user.ts
// Ported to SolidJS for Proyecto Viviana; based on packages/@react-aria/test-utils/src/userEventMaps.ts

// Port of packages/@react-aria/test-utils/src/userEventMaps.ts.
// Port of packages/@react-aria/test-utils/src/user.ts.
