...
const tabsRoot = style<TabsStyleState>({
  ...
  font: "ui",
  /* Glasselated: tabs are navigation, and every nav row the handoff draws is mono
   * (TerminalGlassLab.tsx:598). `font: "ui"` above still owns the size ramp; this
   * only repoints the family, which is why it comes after. */
  fontFamily: "code",
});
