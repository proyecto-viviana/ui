 ...
 * Do not edit by hand.
 */
// Generator input: @react-spectrum/s2@1.7.0/icons/Order.mjs
// Generator input: @react-spectrum/s2@1.7.0/icons/Order.cjs

import type { JSX } from "@solidjs/web";
import { createIcon } from "../spectrum-icon";
import { splitProps } from "@proyecto-viviana/solidaria/utils";

function OrderIconSvg(props: JSX.SvgSVGAttributes<SVGSVGElement>): JSX.Element {
...
export type OrderIconProps = JSX.SvgSVGAttributes<SVGSVGElement>;
export const OrderIcon = createIcon(OrderIconSvg);
