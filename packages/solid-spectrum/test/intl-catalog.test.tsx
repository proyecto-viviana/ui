/**
 * Failing-first S2 catalog check: every shipped locale must match the pinned
 * @react-spectrum/s2 JSON exactly. A missing key, extra key, or drifted value
 * fails this test.
 */
...
const LOCAL_INTL = path.join(process.cwd(), "packages/solid-spectrum/src/intl");
