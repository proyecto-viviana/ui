...
const subpathEntries = [
  ...
  "src/Heading.ts",
  "src/Icon.ts",
  "src/IllustratedMessage.ts",
  "src/Image.ts",
  "src/ImageCoordinator.ts",
  "src/InlineAlert.ts",
  "src/Keyboard.ts",
  "src/LabeledValue.ts",
  "src/Link.ts",
  "src/MenuHamburgerIcon.ts",
  "src/Meter.ts",
  "src/NumberField.ts",
  "src/Popover.ts",
  "src/ProgressBar.ts",
  "src/ProgressCircle.ts",
  "src/RadioGroup.ts",
  "src/RangeSlider.ts",
  "src/SearchIcon.ts",
  "src/SelectBoxGroup.ts",
  "src/Skeleton.ts",
  "src/Slider.ts",
  "src/StatusLight.ts",
  "src/StepList.ts",
