...
// Ported to SolidJS for Proyecto Viviana; based on packages/react-aria-components/src/Virtualizer.tsx
 ...
 *
 * Provides the React Aria Components API and the React Aria scroll-view
 * behavior. Based on:
