...
const errorStrings: Record<string, Record<DateFieldErrorKey, DateFieldErrorMessage>> = {
  ...
  "ko-KR": {
    ...
    rangeUnderflow: (args) =>
      `\u{AC12}\u{C740} ${args.minValue} \u{C774}\u{D6C4}\u{C5EC}\u{C57C} \u{D569}\u{B2C8}\u{B2E4}.`,
...
function getMessageForLocale(key: DateFieldErrorKey, locale: string): DateFieldErrorMessage {
