...
// Ported to SolidJS for Proyecto Viviana; based on packages/react-stately/src/datepicker/useTimeFieldState.ts

/**
 * TimeFieldState for Solid-Stately
 *
 * Faithful port of
 * `packages/react-stately/src/datepicker/useTimeFieldState.ts`, which is a thin
 * wrapper over `useDateFieldState`: a time-only `Time` value is converted
