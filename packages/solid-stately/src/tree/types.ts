...
// Ported to SolidJS for Proyecto Viviana; based on packages/react-stately/src/tree/TreeCollection.ts
// Ported to SolidJS for Proyecto Viviana; based on packages/react-stately/src/tree/useTreeState.ts
