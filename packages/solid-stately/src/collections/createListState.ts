...
// Ported to SolidJS for Proyecto Viviana; based on packages/react-stately/src/list/useListState.ts
// Ported to SolidJS for Proyecto Viviana; based on packages/react-stately/src/list/useSingleSelectListState.ts
