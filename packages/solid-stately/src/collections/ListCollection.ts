...
// Ported to SolidJS for Proyecto Viviana; based on packages/react-aria/src/collections/BaseCollection.ts
// Ported to SolidJS for Proyecto Viviana; based on packages/react-stately/src/list/ListCollection.ts
 ...
 *
 * Ported from:
 * - packages/react-stately/src/list/ListCollection.ts
