...
// Ported to SolidJS for Proyecto Viviana; based on packages/react-stately/src/selection/Selection.ts

/**
 * A Selection is a special Set containing Keys, which also has an anchor
 * and current selected key for use when range selecting.
 *
 * Ported from packages/react-stately/src/selection/Selection.ts.
 */
