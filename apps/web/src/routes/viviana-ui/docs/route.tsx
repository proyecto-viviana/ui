...
import { For, createSignal, Show, onSettled, onCleanup } from "solid-js";
...
/* Copied from solid-spectrum/docs/route.tsx — do not extract DocsChrome.
   Chrome and live previews both wear the house Glasselated register. */
...
function buildSectionItems(
  ...
  basePath: "/viviana-ui/docs/components" | "/viviana-ui/docs/hooks",
  order: string[],
  fmt: (s: string) => string,
): NavItem[] {
...
const navItems: NavEntry[] = [
  { label: "Getting Started", href: "/viviana-ui/docs" },
  { label: "Installation", href: "/viviana-ui/docs/installation" },
  { label: "API reference", href: "/docs" },
  {
    section: "Components",
    items: buildSectionItems(
      componentPages,
      "/viviana-ui/docs/components",
      componentOrder,
      toTitleCase,
    ),
  },
  {
    section: "Hooks",
    items: buildSectionItems(hookPages, "/viviana-ui/docs/hooks", hookOrder, toCamelCase),
  },
];
...
function DocsLayout() {
  ...
  const isActive = (href: string) => {
    ...
    return href === "/viviana-ui/docs"
      ? path === "/viviana-ui/docs" || path === "/viviana-ui/docs/"
      : path === href;
  };
