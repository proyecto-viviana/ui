...
export const Route = createFileRoute("/viviana-ui/docs/installation")({
  head: () =>
    seo({
      title: "Install Viviana UI",
      description:
        "Pick a package, install it, import components.css, and wrap your app in a Provider. Every step here is checked against what the packages actually export.",
      path: "/viviana-ui/docs/installation",
    }),
