...
export const BASE_DARK: TokenMap = {
  ...
  "--color-accent": "#4ba3ff",
  "--color-accent-50": "#081018",
  "--color-accent-100": "#ddf4ff",
  "--color-accent-200": "#b6e3ff",
  "--color-accent-300": "#80ccff",
  "--color-accent-400": "#54aeff",
  "--color-accent-500": "#4da0ff",
  "--color-accent-600": "#3080f4",
  "--color-accent-700": "#1158c7",
  "--color-accent-800": "#0d419d",
  "--color-accent-900": "#050a12",
  "--color-accent-highlight": "#80ccff",
  ...
  "--color-accent-dim": "#1a3040",
  "--color-header-bg": "#181818",
  "--color-primary-glow": "rgba(128, 204, 255, 0.6)",
  "--color-accent-glow": "rgba(128, 204, 255, 0.6)",
...
export const BASE_LIGHT: TokenMap = {
  ...
  "--color-accent-100": "#06131d",
  "--color-accent-200": "#0c2436",
  "--color-accent-300": "#133a54",
  "--color-accent-400": "#195073",
  "--color-accent-500": "#1e6090",
  "--color-accent-600": "#2470a5",
  "--color-accent-700": "#5ea8d0",
  "--color-accent-800": "#9dcce4",
  "--color-accent-900": "#0d2a3d",
  "--color-accent-highlight": "#133a54",
  "--color-success-100": "#e5fff3",
  ...
  "--color-accent-dim": "#b6d9eb",
  "--color-header-bg": "#d0e4ed",
  "--color-primary-glow": "rgba(117, 171, 199, 0.4)",
  "--color-accent-glow": "rgba(117, 171, 199, 0.4)",
