...
| `size` | `"L" | "M" | "S" | "XL" | undefined` | 'M' | The size of the Meter. |
...
| `variant` | `"informative" | "negative" | "notice" | "positive" | undefined` | 'informative' | The [visual style](https://spectrum.adobe.com/page/meter/#-Options) of the Meter. |
