...
| `size` | `"L" | "M" | "S" | "XL" | undefined` | 'M' | The size of the Button. |
...
| `variant` | `"accent" | "genai" | "negative" | "premium" | "primary" | "secondary" | undefined` | 'primary' | The [visual style](https://spectrum.adobe.com/page/button/#Options) of the button. |
