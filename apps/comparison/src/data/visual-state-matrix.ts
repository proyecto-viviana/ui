  ...
  tabs: [
    {
      ...
      note: "The route controls mount both public packages and drive required labels, controlled/default selection, disabled keys, root disabled state, automatic/manual keyboard activation, orientation, density, labelBehavior, icon+Text slots, force-mounted panels, and static/dynamic TabList composition.",
    },
    {
    ...
    },
    {
      ...
      pairDiff: "planned",
      spec: "e2e/tabs-visual.spec.ts",
      note: "Computed and visual contracts are planned after the remaining upstream style deltas are closed, including neutral indicator tokens, label-hidden text behavior, vertical spacing, panel color/flex behavior, and horizontal overflow collapse.",
    },
    {
      ...
      solid: "planned",
      pairDiff: "blocked",
      spec: "apps/comparison/node_modules/@react-spectrum/s2/src/Tabs.tsx",
      note: "React Spectrum S2 measures hidden tabs and collapses horizontal overflow into the S2 Tabs Picker. Solid Tabs still render the tab row at all widths, so acceptance is blocked until that branch is ported or deliberately scoped out by a later decision.",
    },
  ],
  meter: [
    visualDefaultState({
