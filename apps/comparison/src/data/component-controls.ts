...
import {
  componentDemoLoaders,
  hasComponentControlGroup,
  type ComponentDemoLoaderSlug,
} from "./component-demo-loaders";
...
function createProviderControls(demo: typeof import("./provider-demo")): ComponentControlGroup {
  const { providerBackgroundOptions, providerColorSchemeOptions, providerDemoDefaults } = demo;
  return {
    slug: "provider",
    title: "Provider",
    coverage: "modeled",
...
function createButtonControls(demo: typeof import("./button-demo")): ComponentControlGroup {
  const {
    buttonDemoDefaults,
...
function createCardControls(demo: typeof import("./card-demo")): ComponentControlGroup {
  const { cardDemoDefaults, cardDensityOptions, cardSizeOptions, cardVariantOptions } = demo;
  return {
    slug: "card",
    title: "Card",
    coverage: "modeled",
...
function createAccordionControls(demo: typeof import("./accordion-demo")): ComponentControlGroup {
  const { accordionDemoDefaults, accordionDensityOptions, accordionSizeOptions } = demo;
  return {
    slug: "accordion",
    title: "Accordion",
    coverage: "modeled",
...
function createDisclosureControls(demo: typeof import("./disclosure-demo")): ComponentControlGroup {
  const {
...
function createActionBarControls(demo: typeof import("./actionbar-demo")): ComponentControlGroup {
  const { actionBarDemoDefaults, actionBarSelectedItemCountOptions } = demo;
  return {
    slug: "actionbar",
    title: "ActionBar",
    coverage: "modeled",
...
function createActionMenuControls(demo: typeof import("./actionmenu-demo")): ComponentControlGroup {
  const {
...
function createMenuControls(demo: typeof import("./menu-demo")): ComponentControlGroup {
  const {
    menuAlignOptions,
    menuDemoDefaults,
...
function createBreadcrumbsControls(
  demo: typeof import("./breadcrumbs-demo"),
): ComponentControlGroup {
  const { breadcrumbsDemoDefaults, breadcrumbsItemSetOptions, breadcrumbsSizeOptions } = demo;
  return {
    slug: "breadcrumbs",
    title: "Breadcrumbs",
    coverage: "modeled",
...
function createCheckboxControls(demo: typeof import("./checkbox-demo")): ComponentControlGroup {
  const {
...
function createCheckboxGroupControls(
  demo: typeof import("./checkboxgroup-demo"),
): ComponentControlGroup {
  const {
...
function createSwitchControls(demo: typeof import("./switch-demo")): ComponentControlGroup {
  const { switchDemoDefaults, switchSizeOptions } = demo;
  return {
    slug: "switch",
    title: "Switch",
    coverage: "modeled",
...
function createTabsControls(demo: typeof import("./tabs-demo")): ComponentControlGroup {
  const {
...
function createAvatarControls(demo: typeof import("./avatar-demo")): ComponentControlGroup {
  const { avatarDemoDefaults, avatarSizeOptions } = demo;
  return {
    slug: "avatar",
    title: "Avatar",
    coverage: "modeled",
...
function createAvatarGroupControls(
  demo: typeof import("./avatar-group-demo"),
): ComponentControlGroup {
  const { avatarGroupDemoDefaults, avatarGroupSizeOptions } = demo;
  return {
    slug: "avatargroup",
    title: "AvatarGroup",
    coverage: "modeled",
...
function createImageControls(demo: typeof import("./image-demo")): ComponentControlGroup {
  const { imageDemoDefaults, imageObjectFitOptions, imageSourceModeOptions } = demo;
  return {
    slug: "image",
    title: "Image",
    coverage: "modeled",
...
function createSkeletonControls(demo: typeof import("./skeleton-demo")): ComponentControlGroup {
  const { skeletonDemoDefaults } = demo;
  return {
    slug: "skeleton",
    title: "Skeleton",
    coverage: "modeled",
...
function createLinkControls(demo: typeof import("./link-demo")): ComponentControlGroup {
  const { linkDemoDefaults, linkStaticColorOptions, linkVariantOptions } = demo;
  return {
    slug: "link",
    title: "Link",
    coverage: "modeled",
...
function createBadgeControls(demo: typeof import("./badge-demo")): ComponentControlGroup {
  const {
    badgeDemoDefaults,
...
function createStatusLightControls(
  demo: typeof import("./statuslight-demo"),
): ComponentControlGroup {
  const {
...
function createDividerControls(demo: typeof import("./divider-demo")): ComponentControlGroup {
  const {
    dividerDemoDefaults,
...
function createDropZoneControls(demo: typeof import("./dropzone-demo")): ComponentControlGroup {
  const { dropZoneDemoDefaults, dropZoneSizeOptions } = demo;
  return {
    slug: "dropzone",
    title: "DropZone",
    coverage: "modeled",
...
function createIllustratedMessageControls(
  demo: typeof import("./illustratedmessage-demo"),
): ComponentControlGroup {
  const {
...
function createIconsControls(demo: typeof import("./icons-demo")): ComponentControlGroup {
  const { iconsDemoDefaults } = demo;
  return {
    slug: "icons",
    title: "Icons",
    coverage: "modeled",
...
function createIllustrationsControls(
  demo: typeof import("./illustrations-demo"),
): ComponentControlGroup {
  const { illustrationPrimitiveSizeOptions, illustrationsDemoDefaults } = demo;
  return {
    slug: "illustrations",
    title: "Illustrations",
    coverage: "modeled",
...
function createInlineAlertControls(
  demo: typeof import("./inlinealert-demo"),
): ComponentControlGroup {
  const { inlineAlertDemoDefaults, inlineAlertFillStyleOptions, inlineAlertVariantOptions } = demo;
  return {
    slug: "inlinealert",
    title: "InlineAlert",
    coverage: "modeled",
...
function createMeterControls(demo: typeof import("./meter-demo")): ComponentControlGroup {
  const {
    meterDemoDefaults,
...
function createProgressBarControls(demo: typeof import("./progress-demo")): ComponentControlGroup {
  const {
...
function createProgressCircleControls(
  demo: typeof import("./progress-demo"),
): ComponentControlGroup {
  const {
  ...
  return {
    ...
    controls: [
      ...
      },
      {
        ...
        options: [
          {
            value: progressCircleStaticColorOptions[1],
            label: progressCircleStaticColorOptions[1],
          },
          {
            value: progressCircleStaticColorOptions[2],
            label: progressCircleStaticColorOptions[2],
          },
          {
            value: progressCircleStaticColorOptions[3],
            label: progressCircleStaticColorOptions[3],
          },
        ],
      },
      {
...
function createFormControls(demo: typeof import("./form-demo")): ComponentControlGroup {
  const {
    formDemoDefaults,
...
function createRadioGroupControls(demo: typeof import("./radiogroup-demo")): ComponentControlGroup {
  const {
...
function createColorAreaControls(demo: typeof import("./colorarea-demo")): ComponentControlGroup {
  const {
...
function createColorSliderControls(
  demo: typeof import("./colorslider-demo"),
): ComponentControlGroup {
  const {
...
function createColorWheelControls(demo: typeof import("./colorwheel-demo")): ComponentControlGroup {
  const { colorWheelDemoDefaults, colorWheelSizeOptions, colorWheelValueSourceOptions } = demo;
  return {
    slug: "colorwheel",
    title: "ColorWheel",
    coverage: "modeled",
...
function createColorSwatchControls(
  demo: typeof import("./colorswatch-demo"),
): ComponentControlGroup {
  const { colorSwatchDemoDefaults, colorSwatchRoundingOptions, colorSwatchSizeOptions } = demo;
  return {
    slug: "colorswatch",
    title: "ColorSwatch",
    coverage: "modeled",
...
function createColorSwatchPickerControls(
  demo: typeof import("./colorswatchpicker-demo"),
): ComponentControlGroup {
  const {
...
function createColorFieldControls(demo: typeof import("./colorfield-demo")): ComponentControlGroup {
  const {
...
function createRangeSliderControls(
  demo: typeof import("./rangeslider-demo"),
): ComponentControlGroup {
  const {
...
function createSliderControls(demo: typeof import("./slider-demo")): ComponentControlGroup {
  const {
...
function createTextFieldControls(demo: typeof import("./textfield-demo")): ComponentControlGroup {
  const { textFieldDemoDefaults, textFieldSizeOptions } = demo;
  return {
    slug: "textfield",
    title: "TextField",
    coverage: "modeled",
...
function createSearchFieldControls(
  demo: typeof import("./searchfield-demo"),
): ComponentControlGroup {
  const {
...
function createTextAreaControls(demo: typeof import("./textarea-demo")): ComponentControlGroup {
  const { textAreaDemoDefaults, textAreaSizeOptions } = demo;
  return {
    slug: "textarea",
    title: "TextArea",
    coverage: "modeled",
...
function createDialogControls(demo: typeof import("./dialog-demo")): ComponentControlGroup {
  const { dialogDemoDefaults, dialogRoleOptions, dialogSizeOptions, dialogVariantOptions } = demo;
  return {
    slug: "dialog",
    title: "Dialog",
    coverage: "modeled",
...
function createPickerControls(demo: typeof import("./picker-demo")): ComponentControlGroup {
  const {
    pickerAlignOptions,
    pickerDemoDefaults,
  ...
  return {
    ...
    controls: [
      ...
      },
      {
        ...
        kind: "radio",
        defaultValue: pickerDemoDefaults.selectionSource,
        options: options(pickerSelectionSourceOptions),
      },
      {
        name: "placeholder",
        label: "placeholder",
      ...
      },
      {
        ...
        label: "labelPosition",
        kind: "radio",
        defaultValue: pickerDemoDefaults.labelPosition,
        options: options(pickerLabelPositionOptions),
      },
      {
        name: "labelAlign",
        label: "labelAlign",
        kind: "radio",
        defaultValue: pickerDemoDefaults.labelAlign,
        options: options(pickerLabelAlignOptions),
      },
      {
        name: "necessityIndicator",
        label: "necessityIndicator",
        kind: "radio",
        defaultValue: pickerDemoDefaults.necessityIndicator,
        options: options(pickerNecessityIndicatorOptions),
      },
      {
        name: "description",
        label: "description",
      ...
      },
      {
        ...
        label: "name",
        kind: "text",
        defaultValue: pickerDemoDefaults.name,
      },
      {
        name: "form",
        label: "form",
        kind: "text",
        defaultValue: pickerDemoDefaults.form,
      },
      {
        name: "validationBehavior",
        label: "validationBehavior",
      ...
      },
      {
        ...
        label: "direction",
        kind: "radio",
        defaultValue: pickerDemoDefaults.direction,
        options: options(pickerDirectionOptions),
      },
      {
        name: "align",
        label: "align",
        kind: "radio",
        defaultValue: pickerDemoDefaults.align,
        options: options(pickerAlignOptions),
      },
      {
        name: "menuWidth",
        label: "menuWidth",
        kind: "text",
        defaultValue: pickerDemoDefaults.menuWidth,
      },
      {
        name: "loadingState",
        label: "loadingState",
        kind: "radio",
        defaultValue: pickerDemoDefaults.loadingState,
        options: options(pickerLoadingStateOptions),
      },
      {
        name: "isQuiet",
        label: "isQuiet",
      ...
      },
      {
        ...
        label: "shouldFlip",
        kind: "switch",
        defaultValue: pickerDemoDefaults.shouldFlip,
      },
      {
...
function createComboBoxControls(demo: typeof import("./combobox-demo")): ComponentControlGroup {
  const {
  ...
  return {
    ...
    controls: [
      ...
      },
      {
        ...
        label: "itemsSource",
        kind: "radio",
        defaultValue: comboBoxDemoDefaults.itemsSource,
        options: options(comboBoxItemsSourceOptions),
        isHidden: true,
      },
      {
        name: "itemsPreset",
        label: "itemsPreset",
        kind: "select",
        defaultValue: comboBoxDemoDefaults.itemsPreset,
        options: options(comboBoxItemsPresetOptions),
        isHidden: true,
      },
      {
        name: "layout",
        label: "layout",
        kind: "select",
        defaultValue: comboBoxDemoDefaults.layout,
        options: options(comboBoxLayoutOptions),
        isHidden: true,
      },
      {
        name: "sentinels",
      ...
      },
      {
        ...
        label: "loadingState",
        kind: "select",
        defaultValue: comboBoxDemoDefaults.loadingState,
        options: options(comboBoxLoadingStateOptions),
        isHidden: true,
      },
      {
        name: "autoFocus",
      ...
      },
      {
        ...
        label: "shouldCloseOnBlur",
        kind: "switch",
        defaultValue: comboBoxDemoDefaults.shouldCloseOnBlur,
        isHidden: true,
      },
      {
        name: "prefix",
        label: "prefix",
        kind: "text",
        defaultValue: comboBoxDemoDefaults.prefix,
        isHidden: true,
      },
      {
        name: "eventLog",
...
function createDateFieldControls(demo: typeof import("./datefield-demo")): ComponentControlGroup {
  const {
...
function createTimeFieldControls(demo: typeof import("./timefield-demo")): ComponentControlGroup {
  const {
...
function createDatePickerControls(demo: typeof import("./datepicker-demo")): ComponentControlGroup {
  const {
...
function createDateRangePickerControls(
  demo: typeof import("./daterangepicker-demo"),
): ComponentControlGroup {
  const {
...
function createRangeCalendarControls(
  demo: typeof import("./rangecalendar-demo"),
): ComponentControlGroup {
  const {
...
function createCalendarControls(demo: typeof import("./calendar-demo")): ComponentControlGroup {
  const {
...
function createActionButtonControls(
  demo: typeof import("./actionbutton-demo"),
): ComponentControlGroup {
  const {
...
function createLinkButtonControls(
  demo: typeof import("./button-demo") & typeof import("./button-family-demo"),
): ComponentControlGroup {
  const {
    buttonFillStyleOptions,
...
function createToggleButtonControls(
  demo: typeof import("./actionbutton-demo") &
    typeof import("./button-demo") &
    typeof import("./button-family-demo"),
): ComponentControlGroup {
  const {
    actionButtonSizeOptions,
    actionButtonStaticColorOptions,
...
function createActionButtonGroupControls(
  demo: typeof import("./actionbutton-demo") & typeof import("./button-family-demo"),
): ComponentControlGroup {
  const {
    actionButtonIconPlacementOptions,
    actionButtonSizeOptions,
...
function createButtonGroupControls(
  demo: typeof import("./button-demo") & typeof import("./button-family-demo"),
): ComponentControlGroup {
  const {
    buttonIconPlacementOptions,
...
function createToggleButtonGroupControls(
  demo: typeof import("./actionbutton-demo") &
    typeof import("./button-demo") &
    typeof import("./button-family-demo"),
): ComponentControlGroup {
...
function createSegmentedControlControls(
  demo: typeof import("./segmentedcontrol-demo"),
): ComponentControlGroup {
  const {
...
function createSelectBoxGroupControls(
  demo: typeof import("./selectboxgroup-demo"),
): ComponentControlGroup {
  const {
...
function createTagGroupControls(demo: typeof import("./taggroup-demo")): ComponentControlGroup {
  const {
...
function createListViewControls(demo: typeof import("./listview-demo")): ComponentControlGroup {
  const {
...
function createTreeViewControls(demo: typeof import("./treeview-demo")): ComponentControlGroup {
  const {
...
function createTableViewControls(demo: typeof import("./tableview-demo")): ComponentControlGroup {
  const {
...
function createCardViewControls(demo: typeof import("./cardview-demo")): ComponentControlGroup {
  const {
...
function createContextualHelpControls(
  demo: typeof import("./contextualhelp-demo"),
): ComponentControlGroup {
  const {
...
function createPopoverControls(demo: typeof import("./popover-demo")): ComponentControlGroup {
  const {
    popoverDemoDefaults,
...
function createTooltipControls(demo: typeof import("./tooltip-demo")): ComponentControlGroup {
  const {
    tooltipDemoDefaults,
...
function createToastControls(demo: typeof import("./toast-demo")): ComponentControlGroup {
  const { toastActiveSideOptions, toastDemoDefaults, toastPlacementOptions, toastVariantOptions } =
    demo;
  return {
    slug: "toast",
    title: "Toast",
...
function gapControlGroup(entry: ComparisonEntry): ComponentControlGroup {
  return {
    slug: entry.slug,
    title: entry.title,
    coverage: "gap",
...
const controlGroupBuilders = {
  provider: createProviderControls,
  button: createButtonControls,
  card: createCardControls,
  accordion: createAccordionControls,
  disclosure: createDisclosureControls,
  actionbar: createActionBarControls,
  actionmenu: createActionMenuControls,
  menu: createMenuControls,
  breadcrumbs: createBreadcrumbsControls,
  checkbox: createCheckboxControls,
  checkboxgroup: createCheckboxGroupControls,
  switch: createSwitchControls,
  tabs: createTabsControls,
  avatar: createAvatarControls,
  avatargroup: createAvatarGroupControls,
  image: createImageControls,
  skeleton: createSkeletonControls,
  link: createLinkControls,
  badge: createBadgeControls,
  statuslight: createStatusLightControls,
  divider: createDividerControls,
  dropzone: createDropZoneControls,
  illustratedmessage: createIllustratedMessageControls,
  icons: createIconsControls,
  illustrations: createIllustrationsControls,
  inlinealert: createInlineAlertControls,
  meter: createMeterControls,
  progressbar: createProgressBarControls,
  progresscircle: createProgressCircleControls,
  form: createFormControls,
  radiogroup: createRadioGroupControls,
  numberfield: createNumberFieldControls,
  colorarea: createColorAreaControls,
  colorslider: createColorSliderControls,
  colorwheel: createColorWheelControls,
  colorswatch: createColorSwatchControls,
  colorswatchpicker: createColorSwatchPickerControls,
  colorfield: createColorFieldControls,
  rangeslider: createRangeSliderControls,
  slider: createSliderControls,
  textfield: createTextFieldControls,
  searchfield: createSearchFieldControls,
  textarea: createTextAreaControls,
  dialog: createDialogControls,
  picker: createPickerControls,
  combobox: createComboBoxControls,
  datefield: createDateFieldControls,
  timefield: createTimeFieldControls,
  datepicker: createDatePickerControls,
  daterangepicker: createDateRangePickerControls,
  rangecalendar: createRangeCalendarControls,
  calendar: createCalendarControls,
  actionbutton: createActionButtonControls,
  linkbutton: createLinkButtonControls,
  togglebutton: createToggleButtonControls,
  actionbuttongroup: createActionButtonGroupControls,
  buttongroup: createButtonGroupControls,
  togglebuttongroup: createToggleButtonGroupControls,
  segmentedcontrol: createSegmentedControlControls,
  selectboxgroup: createSelectBoxGroupControls,
  taggroup: createTagGroupControls,
  listview: createListViewControls,
  treeview: createTreeViewControls,
  tableview: createTableViewControls,
  cardview: createCardViewControls,
  contextualhelp: createContextualHelpControls,
  popover: createPopoverControls,
  tooltip: createTooltipControls,
  toast: createToastControls,
} as const;

const loadedControlGroups = new Map<string, Promise<ComponentControlGroup>>();

export const comparisonControlsEvent = "comparison:controls-change";

export const componentControlGroupSlugs = Object.keys(
  componentDemoLoaders,
) as ComponentDemoLoaderSlug[];

export async function getComponentControlGroup(
  entry: ComparisonEntry,
): Promise<ComponentControlGroup> {
  const cached = loadedControlGroups.get(entry.slug);
  if (cached) {
    return cached;
  }

  const pending = (async () => {
    if (!hasComponentControlGroup(entry.slug)) {
      return gapControlGroup(entry);
    }

    const demo = await componentDemoLoaders[entry.slug]();
    return controlGroupBuilders[entry.slug](demo as never);
  })();

  loadedControlGroups.set(entry.slug, pending);
  return pending;
}

export async function loadComponentControlGroups(): Promise<Record<string, ComponentControlGroup>> {
  const groups = await Promise.all(
    componentControlGroupSlugs.map(async (slug) => {
      const group = await getComponentControlGroup({
        slug,
        title: slug,
      } as ComparisonEntry);
      return [slug, group] as const;
    }),
  );
