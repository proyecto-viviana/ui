...
const tableViewControls: ComponentControlGroup = {
  ...
  note: "Modeled from the S2 TableView docs/API surface. The viewer drives dynamic visible columns/add-row collection data, density, quiet chrome, wrap/truncate overflow, selection mode, controlled/default selected keys, disabledKeys, row isDisabled, empty state, sorting, column resizing affordances, cell alignment/dividers, row links, onAction, and renderActionBar into both stacks.",
};
