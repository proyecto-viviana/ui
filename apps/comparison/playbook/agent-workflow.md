...
- No agent may substitute one gate for another. Source parity, docs/viewer
  ...
  known-defect/regression protection remain separate.
...
| Defect audit agent            | Task 13        | Component notes, blockers, TODO/FIXME comments, skipped/failing tests, reports, observed UI bugs | Known-defects checklist, acceptance gates, tests signoff | Known-defect table, blocker classification, regression coverage gaps                        | Validation note only                        |
...
| 13 Acceptance          | Check gates, known defects, blockers, reports, tests, and handoff        | Defect audit agent, acceptance reviewer, coordinator |
...
- Bad parallelism: a defect audit running before focused failures and known
  visual/behavior bugs have been recorded in the component note.
...
- A known user-visible bug is treated as non-blocking without a classification,
  owner, and regression plan.
