...
| Current pass    | `./Disclosure` package subpath collided with the `src/disclosure` directory in build output.     | export bug      | no        | `disclosure-export.ts`, package exports, tsup entries, build and export report.       |
