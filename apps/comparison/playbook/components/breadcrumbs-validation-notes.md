...
| 9 Styled S2            | done    | Generated S2 breadcrumb styles, localized overflow trigger, separator placement, bounded default visual evidence | Responsive auto-collapse remains tracked            |
...
| 13 Acceptance          | partial | API/route/behavior accepted; responsive overflow pixel parity is tracked                                         | Owner: future Breadcrumbs responsive collapse slice |
...
| Upstream React Source Parity             | partial | Public API and route behavior mapped; React responsive measurement collapse is not fully ported      | Future slice   |
...
| Style Source-To-Computed Parity          | partial | Default path has bounded pair-diff and computed style parity; overflow menu visual delegates to Menu | Future slice   |
...
- [ ] React S2 responsive measurement collapse is not fully ported; Solid
      currently uses deterministic count-based overflow.
...
Partial acceptance for this Breadcrumbs pass: public API, route harness,
behavior, i18n, and default visual evidence are in place. The remaining tracked
gap is React S2's responsive overflow measurement behavior versus Solid's
current deterministic overflow model.
