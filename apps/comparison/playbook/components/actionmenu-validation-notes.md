...
- Solid package changes:
  ...
  - `packages/solid-spectrum/package.json` and
    `packages/solid-spectrum/vite.config.ts` now publish/build the
...
| Solid public surface     | `packages/solid-spectrum/src/ActionMenu.ts`, `packages/solid-spectrum/src/index.ts`, `packages/solid-spectrum/package.json`, `packages/solid-spectrum/vite.config.ts`                                                                                                                                                 | ActionMenu subpath and root support exports now expose the implemented upstream support values.                                                                                                                                                                                                                                           |
