...
- Legacy accepted under prior playbook: Button family, Divider, Form, Image,
  Link, Meter, Skeleton, and StatusLight.
- Current-gate normalized: ActionBar, ActionMenu, Avatar, AvatarGroup, Badge,
  Button, Calendar, Checkbox, CheckboxGroup, ComboBox, SegmentedControl,
  SelectBoxGroup, and Slider.
