...
| Accessibility And I18n                   | partial | Package and browser tests cover accessible labels, disabled nav, unavailable disabled semantics, invalid error text, first-day headers, and ArrowRight/Enter keyboard focus selection.           | `a11y-blocker`: broader keyboard matrix, international calendars, RTL, and forced-colors semantics remain unproven.         |
