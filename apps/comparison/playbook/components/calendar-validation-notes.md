...
| Style Source-To-Computed Parity          | partial | Visual smoke covers official default and controlled selected states in light/dark.                                                                                                      | `style-blocker`: no strict pair diff or source-to-computed token ledger yet.                                                           |
...
| S2 Style      | Selected date, unavailable date, invalid text, light/dark style branches.                        | `packages/solid-spectrum/src/calendar/index.tsx`                                                               | style           | yes        | partial            | Visual smoke only; computed token ledger and pair diff pending.                     |
