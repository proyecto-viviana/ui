...
history:
  ...
  - {
      state: merged,
      at: 2026-09-13,
      note: "remediated in solidaria createProgressBar.ts and createMeter.ts: retained labelAria and progressBarAria without setup-time destructuring, ensuring fieldProps and progressBarProps getters evaluate per read. Added reactive aria-label test in ProgressCircle.test.tsx. Verified 18/18 unit tests and 27/27 comparison progresscircle certified tests pass.",
    }
---
