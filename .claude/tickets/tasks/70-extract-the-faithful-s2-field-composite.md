...
history:
  ...
  - {
      state: open,
      at: 2026-09-03,
      note: "#260 checkboxgroup: URL ?isInvalid=true&errorMessage= paints React FieldError icon row (field 69×148, helpCount 1, empty error slot, describedby dangling id); Solid stays 69×114 with no HelpText. Remaining work already names missing invalid cases for CheckboxGroup. Native custom validity is #355; live describedby drop is #373. No new id.",
    }
---
