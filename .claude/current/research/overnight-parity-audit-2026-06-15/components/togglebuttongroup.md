# ToggleButtonGroup parity audit seed
...
- `node_modules/.pnpm/@react-spectrum+s2@1.3.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@react-spectrum/s2/exports/ToggleButtonGroup.ts`
- `node_modules/.pnpm/@react-spectrum+s2@1.3.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@react-spectrum/s2/src/ToggleButtonGroup.tsx`

## React Aria Components / React Aria / React Stately hints

- RAC hints: `Button`, `Group`, `ToggleButton`, `ToggleButtonGroup`
...
- Automated source mapping found 4 local seed path(s) and 6 upstream S2 seed path(s).
