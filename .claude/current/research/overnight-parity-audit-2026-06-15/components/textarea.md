...
- `packages/solid-spectrum/src/TextArea.ts`
- `packages/solid-spectrum/src/textfield/TextArea.tsx`
- `packages/solid-spectrum/test/TextArea.test.tsx`
- `packages/viviana-ui/src/TextArea.ts`

## Upstream S2 authority seeds

- `node_modules/.pnpm/@react-spectrum+s2@1.3.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@react-spectrum/s2/dist/exports/TextArea.mjs`
- `node_modules/.pnpm/@react-spectrum+s2@1.3.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@react-spectrum/s2/dist/types/exports/TextArea.d.ts`
- `node_modules/.pnpm/@react-spectrum+s2@1.3.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@react-spectrum/s2/exports/TextArea.ts`

## React Aria Components / React Aria / React Stately hints

- RAC hints: `Text`, `TextArea`
...
- Validation notes: `apps/comparison/playbook/components/textarea-validation-notes.md`.
- E2E specs: `apps/comparison/e2e/textarea-visual.spec.ts`.
...
- Automated source mapping found 4 local seed path(s) and 3 upstream S2 seed path(s).
