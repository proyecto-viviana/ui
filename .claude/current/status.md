...
37/37, with the global bare-ui-icon fix).
...
| Recertification march | `comparison:test:certified`: `1290/1300` — Toast certified (CP9.35, 37/37); remaining reds are the deferred D4 event-ordering epic                                                                   | Tiers 1–2 certified (28 components), Tier 3 in progress (Toast done 2026-07-06). The march (`recertification.md`) is the depth-parity measure; ~36/70 styled components certified.                                                            |
